...
class Application(object):
    ...
    def buildLayout(self):
        ...
        self.__item['vehicleRotation'] = PanelItem(itemPanel, '... VehicleRotation:', '')
        self.__item['turretRotation'] = PanelItem(itemPanel, '... TurretRotation:', '')
        self.__item['afterShot'] = PanelItem(itemPanel, '... AfterShot:', '')
        self.__item['whileGunDamaged'] = PanelItem(itemPanel, '... WhileGunDamaged:', '')
